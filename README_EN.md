...
# ToDo
* [ ] The following options are temporarily added to resolve the pip dependency.<br>```!python -m pip install . --use-deprecated=legacy-resolver```<br>[tensorflow/models Issue #10375](https://github.com/tensorflow/models/issues/10375)、[Tensorflow2-ObjectDetectionAPI-Colab-Hands-On Issues #2](https://github.com/Kazuhito00/Tensorflow2-ObjectDetectionAPI-Colab-Hands-On/issues/2)
